...
"""
From: https://github.com/black0017/MedicalZooPytorch/blob/master/lib/medzoo/ResNet3DMedNet.py
...
if __name__ == '__main__':
    model = generate_resnet3d(in_channels=3, classes=2, model_depth=50)
